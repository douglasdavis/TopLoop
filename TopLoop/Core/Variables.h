...
namespace TL {
  ...
  protected:
    ...
    DECLARE_BRANCH_PRIMITIVE(weight_bTagSF_DL1_HybBEff_60_extrapolation_from_charm_up   , Float_t       );
    DECLARE_BRANCH_PRIMITIVE(weight_bTagSF_DL1_HybBEff_60_extrapolation_from_charm_down , Float_t       );
