...
/// ATLAS Monte Carlo campaigns
enum class kCampaign { Unknown, Data, MC15c, MC16a, MC16c, MC16d, MC16e, MC16f };

/// ATLAS data taking years
enum class kYear { Unknown = 0, Y2015 = 15, Y2016 = 16, Y2017 = 17, Y2018 = 18 };

/// Generator initial state (the physics process that was generated by the MC)
...
/// Is the MC sample data, used as a nominal prediction, or an alternative systematic sample
